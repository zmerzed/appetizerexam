                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="store">
                            ...
                            <div class="form-group">
                                <label>School<span class="requiredField">*</span></label>
...
<script>
    ...
    export default {
        ...
        methods: {
            store() {
                axios.post(base_url+'examinees', this.form).then((response) => {
                    $('#create-item').modal('hide');
                    this.form = {'first_name':'','last_name':'','school':''};
                    this.errors = null;
                    this.showMassage(response.data);
                    EventBus.$emit('examinee-created', response.data);
                }).catch(error => {
                    if(error.response){
