...
Vue.component('create-examinee', __webpack_require__(35));
Vue.component('view-examinees', __webpack_require__(38));
...
Component.options.__file = "resources\\assets\\js\\components\\CreateExaminee.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4b69a177", Component.options)
  } else {
    hotAPI.reload("data-v-4b69a177", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        store: function store() {
            ...
            axios.post(base_url + 'examinees', this.form).then(function (response) {
                $('#create-item').modal('hide');
                _this.form = { 'first_name': '', 'last_name': '', 'school': '' };
                _this.errors = null;
                _this.showMassage(response.data);
                __WEBPACK_IMPORTED_MODULE_0__vue_assets__["EventBus"].$emit('examinee-created', response.data);
    ...
    mounted: function mounted() {
        ...
        $('#create-item').on('hidden.bs.modal', function () {
            vm.errors = null;
            vm.form = { 'first_name': '', 'last_name': '', 'school': '' };
        });
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4b69a177", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\ViewExaminees.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4c792bc3", Component.options)
  } else {
    hotAPI.reload("data-v-4c792bc3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_assets__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Pagination_vue__ = __webpack_require__(40);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        index: function index(pageNo, filter) {
            ...
            axios.get(base_url + "examinees?page=" + pageNo + "&filter=" + filter).then(function (res) {
        ...
        deleteUser: function deleteUser(id, index) {
            ...
            if (confirm("Do you really want to delete it?")) {
                axios.delete(base_url + 'examinees/' + id).then(function (response) {
    ...
    created: function created() {
        var _this = this;
        _this.index(1);
        __WEBPACK_IMPORTED_MODULE_0__vue_assets__["EventBus"].$on('examinee-created', function () {
            _this.index(1);
        });
    }
});
        ...
        ? _c(
            ...
            _vm._l(_vm.resultData.data, function(value, index) {
              return _c("tr", { staticClass: "tr" }, [
                ...
                _c("td", [
                  _vm._v(
                    _vm._s(value.last_name) + ", " + _vm._s(value.first_name)
                  )
                ]),
                _vm._v(" "),
                _c("td", [
                  value.school
                    ? _c("div", [_vm._v(_vm._s(value.school.name))])
                    : _vm._e()
                ]),
                _vm._v(" "),
                _c("td", [
                  value.school && value.school.division
                    ? _c("div", [_vm._v(_vm._s(value.school.division.name))])
                    : _vm._e()
                ])
              ])
            })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4c792bc3", module.exports)
  }
}
